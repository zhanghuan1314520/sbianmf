...
Page({
    ...
    dealMore: function goHouse(item) {
        ...
        wx.navigateTo({
            url: "/housen/dealog/index?cid=" + cid
        });
    },
    ...
    goReportsa: function (item) {
        ...
        switch (dt.datatype) {
            case "0":
                ...
                t.data.postParam.keywords = "", t.data.postParam.districtid = "", t.data.postParam.sqid = "", t.data.postParam.location = "", //改动:e.sqid
                    t.data.postParam.stationid = "", t.data.postParam.conmmunityid = "", t.filterData(t.data.postParam);
                break;
            case "1":
                var arrname = dt.title.split(" ");
                t.setData({
                    show: !1,
                    page_num: 1,
                    datalist: [],
                ...
                t.data.postParam.keywords = "", t.data.postParam.districtid = arrname[0], t.data.postParam.sqid = "", t.data.postParam.location = "", //改动:e.sqid
                    t.data.postParam.stationid = "", t.data.postParam.conmmunityid = "", t.filterData(t.data.postParam);
                break;
            case "2":
    ...
    getData: function (da) {
        ...
        //console.log(r);
        a.get("reports/get_prolist", r, function (a) {
            t.setData({
                show: !0,
                page_num: a.page,
