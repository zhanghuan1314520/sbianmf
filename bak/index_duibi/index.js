...
Page({
    ...
    get_homechart: function (dt) {
        ...
        a.get("datafangcopy/get_homechart2020", {
            ...
            var ymax=t.calMax(a.chartsData.seriesData1)+5000;//挂牌均价最大值
            var ymix=t.calMix(a.chartsData.seriesData12020)-5000;//成交均价最小值
            var ymax_zhishu=t.calMax(a.chartsData.seriesData)*2; //手边指数最大值
            ...
            setTimeout(function () {
                chart.setOption({
                    ...
                    series: [{
                        name: a.chartsData.lddata[0],
                        data: a.chartsData.seriesData2019,
                        itemStyle: {
                            normal: {
                                label: {
                                    show: false
                        ...
                        name: a.chartsData.lddata[0],
                        data: a.chartsData.seriesData2020,
                        itemStyle: {
                            normal: {
                                label: {
                                    show: false
                        ...
                        name: a.chartsData.lddata[3],
                        data: a.chartsData.seriesData12020

                    }, {
                        name: a.chartsData.lddata[3],
                        data: a.chartsData.seriesData12019
