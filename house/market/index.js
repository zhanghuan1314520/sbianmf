...
Page({
     ...
     */
    onLoad: function(dt) {
       // console.log(getApp().globalData.longitude,getApp().globalData.latitude);
        ...
        //接收搜索页参数
        var dc = getApp().globalData.dtsearch;
        ...
        if ((wx.setNavigationBarTitle({
                ...
                quYuBar2: 11,
                quYuBxBar2: 11
            }), console.log("listParam进入二手房", t.data.list_param), t.getQuYuData(0), t.filterPricesData(),
            ...
            if (dc) {
                ...
                if (dc.ftype == 1) { //搜索区域                  
                    t.data.postParam.keywords = "", t.data.postParam.districtid = dc.title,
                        ...
                        t.data.postParam.nearby = "", t.data.postParam.location = "", t.data.postParam.conmmunityid = "", t.data.postParam.xuequid = "", t.data.postParam.xuequid_new = "";
                    ...
                    t.filterData(t.data.postParam);
                } else if (dc.ftype == 4) { //搜索学区
                    t.data.postParam.keywords = "", t.data.postParam.districtid = "",
                        t.data.postParam.sqid = "", t.data.postParam.lineid = "", t.data.postParam.stationid = "",
                        t.data.postParam.nearby = "", t.data.postParam.location = "", t.data.postParam.conmmunityid = "", t.data.postParam.xuequid = dc.id, t.data.postParam.xuequname = dc.title, t.data.postParam.xuequid_new = "";
                    t.data.tabTxt[0].newname = dc.title;
                    t.setData({
                        tabTxt: t.data.tabTxt,
                        postParam: t.data.postParam,
                    ...
                    t.filterData(t.data.postParam);
                }else if (dc.ftype == 5) { //搜索学区 地图版本
                    t.data.postParam.keywords = "", t.data.postParam.districtid = "",
                        t.data.postParam.sqid = "", t.data.postParam.lineid = "", t.data.postParam.stationid = "",
                        t.data.postParam.nearby = "", t.data.postParam.location = "", t.data.postParam.conmmunityid = "", t.data.postParam.xuequid = "", t.data.postParam.xuequid_new = dc.id, t.data.postParam.xuequname_new = dc.title;
                    t.data.tabTxt[0].newname = dc.title;
                    t.setData({
                        tabTxt: t.data.tabTxt,
                        postParam: t.data.postParam,
                    ...
                    t.filterData(t.data.postParam);
                } else if (dc.ftype == 6) { //房价涨跌
                    t.data.postParam.keywords = "", t.data.postParam.districtid = "",
                        t.data.postParam.sqid = dc.title, t.data.postParam.lineid = "", t.data.postParam.stationid = "",
                        t.data.postParam.nearby = "", t.data.postParam.location = "", t.data.postParam.conmmunityid = "", t.data.postParam.xuequid = "", t.data.postParam.xuequid_new = "";
                        t.data.postParam.pricetype = dc.pricetype;
                   // t.data.tabTxt[0].newname = dc.title;
                    ...
                    t.data.postParam.keywords = "", t.data.postParam.districtid = "",
                        t.data.postParam.sqid = "", t.data.postParam.lineid = "", t.data.postParam.stationid = "",
                        t.data.postParam.nearby = "", t.data.postParam.location = "", t.data.postParam.conmmunityid = dc.id, t.data.postParam.xuequid = "", t.data.postParam.xuequid_new = "";
                ...
                wx.showLoading({
                    ...
                    success: function(a) {
                        ...
                        t.setData({
                            ...
                            t.data.postParam.lineid = "", t.data.postParam.stationid = "", t.data.postParam.conmmunityid = "", t.data.postParam.xuequid = "", t.data.postParam.xuequid_new = "",
                            t.data.postParam.nearby = 1, t.data.postParam.location = t.data.longitude + "," + t.data.latitude;
                            wx.hideLoading(),t.filterData(t.data.postParam);
    ...
    onShow: function() {        
        ...
        this.getInfo(), t.get_datafang(), wx.getSetting({
            success: function(a) {
        ...
        if (dc) {
            if (dc.ftype == 1) { //搜索区域                  
                ...
                t.data.postParam.keywords = "", t.data.postParam.districtid = "",
                    t.data.postParam.sqid = "", t.data.postParam.lineid = "", t.data.postParam.stationid = "",
                    t.data.postParam.nearby = "", t.data.postParam.location = "", t.data.postParam.conmmunityid = "", t.data.postParam.xuequid = dc.id, t.data.postParam.xuequname = dc.title;
                t.data.tabTxt[0].newname = dc.title;
                t.setData({
                    tabTxt: t.data.tabTxt,
                    postParam: t.data.postParam,
                ...
                t.data.postParam.keywords = "", t.data.postParam.districtid = "",
                    t.data.postParam.sqid = "", t.data.postParam.lineid = "", t.data.postParam.stationid = "",
                    t.data.postParam.nearby = "", t.data.postParam.location = "", t.data.postParam.conmmunityid = "",t.data.postParam.xuequid = "", t.data.postParam.xuequid_new = dc.id, t.data.postParam.xuequname_new = dc.title,t.data.postParam.xuequ_type = dc.xuequ_type;
                t.data.tabTxt[0].newname = dc.title;
                t.setData({
                    tabTxt: t.data.tabTxt,
                    postParam: t.data.postParam,
    ...
    get_datafang: function() {
        var t = this;
        a.get("shop/get_uupirce", {}, function(a) {
            1 == t.setData({
                upacount: a.upacount,
                unasale: a.unasale,
                upxcount: a.upxcount,
    ...
    //按楼盘筛选
    getallcommunity: function getallcommunity() {
        var t = this;
        t.getData("");
    },
    //按楼盘筛选
    community: function community(item) {
        ...
        ****/
        ...
        t.data.postParam.keywords = "", t.data.postParam.districtid = "",
            t.data.postParam.sqid = "", t.data.postParam.lineid = "", t.data.postParam.stationid = "",
            t.data.postParam.nearby = "", t.data.postParam.location = "", t.data.postParam.conmmunityid = cid.fid;

        t.setData({
            searchCon: cid.community,
            postParam: t.data.postParam,
            page_num: 1,
            datalist: [],
            show: !1
    ...
    dealMore: function goHouse(item) {
        ...
        wx.navigateTo({
            url: "/house/dealog/index?cid=" + cid
        });
    },
    ...
    onShareAppMessage: function() {
        ...
        st.setData({
            diytitle:'杭州二手房专业比价平台!'
        });

        var t = null, at = null;
        return this.data.diytitle && (t = '/house/market/index', at = this.data.diytitle), 
    ...
    getData: function(da) {
        var t = this,
          ...
          a.get("Business/get_prolist", r, function(a) {
            t.setData({
                show: !0,
                page_num: a.page,
               // datacount: a.datacount,
                community_info: a.community,
                ad: a.ad,
            });
            t.getData_datacount(da);//渲染统计数据
            if (a.datalist.length < 1) {
                wx.showToast({
                    title: '到底，没有数据了！'
                })
    ...
    getData_datacount: function(da) {
        var t = this,
            e = "exchange",
            d = {
                page: t.data.page_num,
                sodo: 'datacount',//先加载房源
                pcount: 15
            },
            r = Object.assign(d, da);
          a.get("Business/get_prolist", r, function(a) {
    ...
    getData1111: function(a) {
        ...
        t.setData({
                loadinghide: !1,
                showAllData: !0
            }), console.log("post_data:", r), 1 == t.data.list_param && (e = "exchange"), 2 == t.data.list_param && (e = "rent"),
            wx.request({
                url: "https://appapi.5i5j.com/appapi/" + e + "/" + t.data.city_id + "/v1/prolist",
                method: "POST",
                data: r,
                header: {
                ...
                success: function(a) {
                    if (console.log("data", a.data), 200 == a.data.status) {
                        if (console.log("count : ", a.data.data.count), 0 == a.data.data.count) t.setData({
                            listHidden: !0,
                            houseNo: !1,
                            loadinghide: !0
                        });
                            ...
                            t.setData({
                                ...
                                showAllData: !1,
                                loadinghide: !0
                            }), console.log("exchangerecord1", a.data.data.exchangerecord);
                        else if (t.data.listLock = 1,
                            t.data.total_page = Math.ceil(a.data.data.count / 15), console.log("total_page", t.data.total_page),
                            t.data.total_page >= t.data.page_num) {
                            var e = t.data.list.concat(a.data.data.list);
                            t.setData({
                                showAllData: !0,
                                listHidden: !1,
                                houseNo: !0,
                                ...
                                sqinfo: a.data.data.exchangerecord,
                                loadinghide: !0
                            }), t.data.page_num += 1, console.log("翻页", t.data.page_num);
                        }
                        1 == t.data.countLock && 1 == t.data.loadinghide && (t.setData({
        ...
        if (1 == t.data.list_param) switch (+e.barid) {
            ...
            case 31:
                t.data.tabTxt[0].newname = e.name, 1 == t.data.dingwei ? (t.setData({
                    ...
                    t.data.postParam.lineid = "", t.data.postParam.stationid = "", t.data.postParam.conmmunityid = "", t.data.postParam.xuequid = "", t.data.postParam.xuequid_new = "",
                    t.data.postParam.nearby = e.nearid, t.data.postParam.location = t.data.longitude + "," + t.data.latitude,console.log(t.data.postParam),
        ...
        if (t.data.tabTxt[0].newname = e.name, 1 == t.data.list_param) switch (+e.barid) {
            case 12:
                t.setData({
                        ...
                        page_num: 1,
                        show: !1
                    }), t.data.postParam.keywords = "", t.data.postParam.location = "", t.data.postParam.districtid = "", t.data.postParam.sqid = t.data.quyuName + ' ' + e.name, //改动:e.sqid
                    t.data.postParam.stationid = "",t.data.postParam.xuequid ="", t.data.postParam.xuequname = "",t.data.postParam.xuequid_new ="", t.data.postParam.xuequname_new = "", t.data.postParam.conmmunityid = "", t.filterData(t.data.postParam),
            ...
            case 42:
                ...
                t.setData({
                        ...
                        page_num: 1,
                        show: !1
                    }), t.data.postParam.conmmunityid = "", t.data.postParam.keywords = "", t.data.postParam.districtid = "", t.data.postParam.sqid = "", t.data.postParam.location = "", //
    ...
    buxianFn2: function(a) {
        ...
        t.data.tabTxt[0].newname = "", t.setData({
            ...
            t.data.postParam.sqid = "", t.data.postParam.lineid = "", t.data.postParam.stationid = "",
                t.data.postParam.nearby = 1, t.data.postParam.location = t.data.longitude + "," + t.data.latitude, t.data.postParam.conmmunityid = "", t.data.postParam.xuequname="",t.data.postParam.xuequid = "",
        ...
        if (t.data.tabTxt[0].newname = t.data.quyuName, 1 == t.data.list_param) switch (+e.bxbarid) {
            case 12:
                ...
                t.setData({
                        ...
                        page_num: 1,
                        show: !1
                    }), t.data.postParam.location="",t.data.postParam.keywords = "", t.data.postParam.sqid = "", t.data.postParam.conmmunityid = "", t.data.postParam.xuequid = "",
            ...
            case 22:
                t.setData({
                        ...
                        loadbarid: 22,
                        datalist: []
                    }), t.data.postParam.location="",t.data.postParam.keywords = "", t.data.postParam.stationid = "", t.data.postParam.conmmunityid = "", t.data.postParam.xuequid = "",
        ...
        if (2 == t.data.list_param) switch (+e.bxbarid) {
            case 12:
                t.setData({
                        ...
                        searchCon: "请输入板块名、楼盘名",
                        list: []
                    }), t.data.postParam.location="",t.data.postParam.keywords = "", t.data.postParam.sqids = "", t.data.postParam.communityid = "", t.data.postParam.xuequid = "",
            ...
            case 22:
                t.setData({
                        ...
                        loadbarid: 22,
                        list: []
                    }), t.data.postParam.location="",t.data.postParam.keywords = "", t.data.postParam.stationid = "", t.data.postParam.communityid = "", t.data.postParam.xuequid = "",
    ...
    /****
    getDiTieData1: function(a) {

        var t = this,
            e = {};
        console.log(e);
        wx.request({
            url: "https://appapi.5i5j.com/appapi/subway/" + t.data.city_id + "/v1/list",
            method: "POST",
            data: e,
            header: {
                "Content-Type": "application/x-www-form-urlencoded;charset=utf-8"
            ...
            success: function(e) {
                console.log(e);
                if (200 == e.data.status) {
                    for (var d = [], r = 0; r < e.data.data.length; r++) d[e.data.data[r].lineid] = e.data.data[r].stationlist;
                    console.log("stArr", d), 0 == a ? t.setData({
                        filterArea: e.data.data
                    }) : t.setData({
                        filterArea2: d[a]
                    });
    ...
    priceConfirm: function(a) {
        ...
        1 == t.data.list_param && (d && !r && (t.data.tabTxt[1].newname = d + "万以上", t.data.priceData = d + ",99999999",
                ...
                t.data.priceData = "0," + r), d && r && (t.data.tabTxt[1].newname = d + "-" + r + "万",
                t.data.priceData = d + "," + r)), 2 == t.data.list_param && (d && !r && (t.data.tabTxt[1].newname = d + "元以上",
                    t.data.priceData = d + ",99999999", t.data.postParam.price = t.data.priceData),
                r && !d && (t.data.tabTxt[1].newname = r + "元以下", t.data.priceData = "0," + r),
                d && r && (t.data.tabTxt[1].newname = d + "-" + r + "元", t.data.priceData = d + "," + r)),
            d || r || (t.data.tabTxt[1].newname = t.data.valPrice), "" == t.data.priceData && (t.data.tabTxt[1].newname = ""),
            t.setData({
                filnav: "",
                tabTxt: t.data.tabTxt,
                tab: [!0, !0, !0, !0],
    ...
    fxingConfirm: function(a) {
        ...
        var t = this,
            e = a.currentTarget.dataset.fxingname,
            d = [];
        d.push(e), t.data.tabTxt[2].newname = e.length > 0 ? d : "", t.setData({
            filnav: "",
            tabTxt: t.data.tabTxt,
            tab: [!0, !0, !0, !0],
            filterMask: !0,
            ...
            case 5:
                    ...
                    if (d.data.moreData[i][s].selected == !d.data.moreData[i][s].selected) {
                        ...
                        if (d.data.moreData[i][s].selected) {
                            ...
                            d.data.postParam.pricetype = "";
                        } else {
                            d.data.moreData[i][s].selected = true;
                            d.data.postParam.pricetype = e;
                        }
                    }
