...
Page({
    ...
    data: {
        ...
        rdu_list: [
            {
                img: "/dfimages/jifen/medal_1.png",
                name: "德胜",
                pop: 1,
                pjj: 33124,
                bjj: 30457
    ...
    getnav: function () {
        ...
        t.setData({
            loading: !1,
            show: !1,
        }), a.get("house_chart.get_prolist", {
        }, function (e) {
            console.log("data值", e)
           t.setData({
            datalist: e.datalist,
      
            datalist_hot:e.datalist_hot
           })
        });

        a.get("house_chart.get_prolist_head", {
        }, function (e) {
            console.log("data值", e)
           t.setData({
    ...
    toSearch: function (a) {
        ...
        "请输入板块名、楼盘名" != t.data.searchCon && (e = t.data.searchCon), 8 == getCurrentPages().length ? wx.redirectTo({
            url: "../market/search?cityId=" + t.data.city_id + "&searchInp=" + e + "&listParam=" + t.data.list_param + "&searchParam=2"
        }) : wx.navigateTo({
            url: "../market/search?cityId=" + t.data.city_id + "&searchInp=" + e + "&listParam=" + t.data.list_param + "&searchParam=2"
        });
    },
    ...
    */
    ...
    prolist: function (e) {
       ...
       console.log("title",title)
        wx.navigateTo({
            url: '/house/house_chart/quyu?title='+title,
        })
    },
    hot: function (e) {
        console.log("eeee",e)
        ...
        console.log("title",title)
         wx.navigateTo({
             url: '/house/house_chart/xiaoqu?title='+title,
         })
     },
     Reports_sort:function(dt) {//排序
       ...
       if(t.data.member.viplevel!=2)
        ...
        var  datalist_hot=t.data.datalist_hot;
        datalist_hot = datalist_hot.sort(t.sort_compare(arr));
        t.setData({
            datalist_hot: datalist_hot,
        })
