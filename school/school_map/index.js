...
Page({
    ...
    searchAddress: function (lat, lng) {
        ...
        wx.showLoading({ 
            title: "加载中..."
        }), console.log(lat, lng, "传入坐标获取详细地理位置"), h && (h.abort(), h = null), h = a.get("dataApiMap/getDetailMapSchoollnglat", {
            lat: lat,
            lng: lng,
    ...
    onShareAppMessage: function () {
        ...
        var t = null, at = null;
        return this.data.diytitle && (t = "/school/school_map/index?lat=" + a.data.markerlatitude + "&lng=" + a.data.markerlongitude + "&districtstatus=" + a.data.districtstatus, at = this.data.diytitle), 
    ...
    doSearchList: function (dt) {
        var t = this;
        a.get("schoolApi/get_searchschool", {
            searchValue: dt
        }, function (a) {
            1 == t.setData({
                searchList: a.list
